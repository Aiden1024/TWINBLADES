    ...
    return (
        <div className=' relative group'>
            ...
            <Card shadow='none' className='relative z-10 border border-default-200 
               transition-all duration-150 ease-out
               translate-x-0 translate-y-0
               hover:-translate-x-1 hover:-translate-y-1 '   isPressable onPress={onOpen}>
                ...
                <CardBody className='  duration-150 flex-col gap-4'>
                    <div className=' flex flex-col my-2 gap-1'>
                        <h2 className=' group-hover:text-primary-500 duration-300  text-header text-lg'>TWINBLADES NEXT</h2>
                        <ScrollShadow className='flex flex-wrap gap-2'>

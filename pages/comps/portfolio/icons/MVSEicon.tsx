const MVSEIcon = ({ className = "",
	st0Class = "fill-[#93C5FD]",
	st1Class = "fill-default-700",
	st2Class = "fill-secondary-500",
	st3Class = "fill-[#DBEAFE]",
	st4Class = "fill-default-600",
	...props }) => {
	return (
		<svg
			className={className}
			...
			width="24"
			height="24"
			viewBox="0 0 444.2 187.1" // 调整 viewBox 以适应你的 path 数据
			fill="currentColor"
		>
			{/* 把你的 SVG 的 path 等内容粘贴在这里 */}
			<g>
				<g>
					<path className={st0Class} d="M226.1,129.1l-8.2,16.8c-0.1,0.3-0.3,0.5-0.6,0.6c-0.3,0.2-0.5,0.2-0.8,0.2c-0.3,0-0.6-0.1-0.8-0.2
			c-0.3-0.2-0.5-0.4-0.6-0.6l-8.2-16.8h3.5l6.1,12.6l6.1-12.6H226.1z"/>
					<path className={st0Class} d="M233.2,130.7h-3.2v-2.9h3.2V130.7z M233.2,146.5h-3.2v-13.1h3.2V146.5z" />
					<path className={st0Class} d="M251.5,142.1c0,0.5-0.1,1-0.2,1.5c-0.1,0.4-0.3,0.8-0.5,1.1c-0.2,0.3-0.5,0.6-0.8,0.8
			...
			c0.3,0.4,0.6,0.9,0.8,1.4C251.4,141.1,251.5,141.6,251.5,142.1z"/>
					<path className={st0Class} d="M259.4,130.7h-3.2v-2.9h3.2V130.7z M259.4,146.5h-3.2v-13.1h3.2V146.5z" />
					<path className={st0Class} d="M279.2,142.1c0,0.5-0.1,1-0.2,1.5c-0.1,0.4-0.3,0.8-0.5,1.1c-0.2,0.3-0.5,0.6-0.8,0.8
			...
			c0,0.4,0.1,0.7,0.3,0.9c0.2,0.2,0.5,0.3,1,0.3h5.7c0.4,0,0.7-0.1,1-0.3c0.2-0.2,0.3-0.5,0.3-0.9V137.8z"/>
					<path className={st0Class} d="M298.9,146.5h-3.2v-7.3c0-0.4-0.1-0.8-0.2-1.1c-0.1-0.3-0.3-0.6-0.6-0.8c-0.2-0.2-0.5-0.4-0.9-0.5
			...
			c0.3,0.4,0.5,0.9,0.7,1.5c0.2,0.6,0.3,1.2,0.3,1.9V146.5z"/>
					<path className={st0Class} d="M324.8,146.5h-3.2v-10.4L316,146c-0.1,0.3-0.3,0.4-0.6,0.6c-0.2,0.1-0.5,0.2-0.8,0.2c-0.3,0-0.5-0.1-0.8-0.2
			...
			c0.3-0.1,0.7-0.1,1-0.1c0.3,0.1,0.6,0.3,0.8,0.6c0.2,0.3,0.3,0.6,0.3,1V146.5z"/>
					<path className={st0Class} d="M344.1,142.1c0,0.4-0.1,0.9-0.2,1.4c-0.2,0.5-0.4,1-0.7,1.4c-0.3,0.4-0.8,0.8-1.3,1.1c-0.6,0.3-1.2,0.4-2,0.4
			...
			V142.1z"/>
					<path className={st0Class} d="M361.3,136.5h-5.5v10h-3.2v-10h-4.1v-3.2h4.1v-4.3h3.2v4.3h5.5V136.5z" />
					<path className={st0Class} d="M377.3,136.5h-7.1c-0.4,0-0.8,0.1-1,0.3c-0.2,0.2-0.3,0.5-0.3,0.9v8.7h-3.2v-8.7c0-0.5,0.1-1,0.2-1.5
			...
			V136.5z"/>
					<path className={st0Class} d="M385.1,130.7H382v-2.9h3.2V130.7z M385.1,146.5H382v-13.1h3.2V146.5z" />
					<path className={st0Class} d="M405.6,133.4l-5.7,6.2l6.4,6.9H402l-4.2-4.6l-4.2,4.6h-4.4l6.4-7l-5.6-6.2h4.3l3.5,3.8l3.5-3.8H405.6z" />
				</g>
				<g>
					<g>
						<g>
							<path className={st1Class} d="M428.1,55.3c1.2-1,2.7-2.3,3.9-3.9c0.3-0.4,0.5-0.3,0.8,0c2.9,2.9,5.9,5.8,8.8,8.7c1.3,1.3,1.2,3.3,0,4.5
					c-1.2,1.3-3.3,1.5-4.5,0.2C434.1,61.8,431.1,58.5,428.1,55.3z"/>
						</g>
						<g>
							<path className={st1Class} d="M411.3,11.4c-12.6-0.1-23.1,10.2-23.2,22.7c0,0.1,0,0.3,0,0.4h6.4c0-9.2,7.5-16.7,16.7-16.7
					c9.3,0,16.7,7.5,16.6,16.7c0,6.7-4,12.4-9.7,15v6.9c9.2-2.9,16-11.6,16.1-21.8C434.4,21.9,424.2,11.5,411.3,11.4z"/>
						</g>
					</g>
				</g>
				<g>
					<path className={st2Class} d="M162.7,103.2H153v-34l-17,32.3c-0.4,0.8-1,1.4-1.8,1.9s-1.6,0.6-2.4,0.6c-0.8,0-1.6-0.2-2.3-0.6
			...
			c1-0.4,2-0.5,3.1-0.2c1,0.3,1.9,0.9,2.5,1.9c0.7,0.9,1,2,1,3.2V103.2z"/>
					<path className={st2Class} d="M243.9,46.1l-25.1,55c-0.4,0.8-1,1.5-1.8,2s-1.6,0.8-2.6,0.8c-0.9,0-1.8-0.3-2.5-0.8s-1.4-1.2-1.8-2l-25.1-55
			h10.8l18.6,41.1l18.7-41.1H243.9z"/>
					<path className={st2Class} d="M323.6,86.4c0,2-0.2,3.9-0.7,5.5c-0.5,1.6-1.1,3.1-1.9,4.3c-0.8,1.2-1.7,2.3-2.8,3.2
			...
			c1.1,0.6,2.2,1.3,3.3,2.2s2,2,2.8,3.2c0.8,1.2,1.4,2.7,1.9,4.3C323.4,82.5,323.6,84.4,323.6,86.4z"/>
					<path className={st2Class} d="M403.9,103.6h-34.7c-1.3,0-2.8-0.3-4.4-0.8c-1.6-0.5-3-1.3-4.4-2.5c-1.3-1.2-2.5-2.7-3.4-4.5
			...
			v10.3h-38.5v32.2c0,1.4,0.3,2.4,1,3.1c0.7,0.7,1.6,1.1,2.9,1.1h34.6V103.6z M399.5,80.3h-30.3V69.9h30.3V80.3z"/>
				...
				<g>
					<path className={st3Class} d="M73.7,177.8c-1.1,0.2-2.2,0.6-3.4,0.8c-7.8,1.6-15.3,0.9-21.6-4.2c-13-10.6-15.1-33.4-15.6-49.1
			...
			C77.7,177.9,75.9,177.3,73.7,177.8z"/>
					<path className={st3Class} d="M131.9,146.3c2.2,0.3,3.5,1.5,3.4,3.4c0,2.1-1.3,3.5-3.5,3.4c-2.2-0.1-3.3-1.5-3.2-3.7
			C128.8,147.4,130.2,146.6,131.9,146.3z"/>
					<path className={st3Class} d="M87.8,174.4c1.9,1.1,2.6,2.7,1.8,4.5c-0.8,1.9-2.6,2.8-4.5,1.8c-1.9-0.9-2.5-2.7-1.5-4.6
			C84.4,174.3,86.1,174,87.8,174.4z"/>
				</g>
				<g>
					<path className={st0Class} d="M157.5,116.6c2.2,0.3,3.5,1.5,3.4,3.4c0,2.1-1.3,3.5-3.5,3.4c-2.2-0.1-3.3-1.5-3.2-3.7
			C154.4,117.8,155.8,116.9,157.5,116.6z"/>
					<path className={st0Class} d="M130.2,161.5c1.9,1.1,2.6,2.7,1.8,4.5c-0.8,1.9-2.6,2.8-4.5,1.8c-1.9-0.9-2.5-2.7-1.5-4.6
			C126.9,161.4,128.6,161.2,130.2,161.5z"/>
					<path className={st0Class} d="M117.3,169.1c-0.9,0.7-1.8,1.4-2.8,2.1c-6.5,4.5-13.7,6.9-21.5,4.7c-16.2-4.6-27-24.7-33.7-38.9
			...
			c12.7,4.4,23.7,1,33.7-7.1c1.6-1.3,2.2-3.1,0.8-4.9C121.1,167.7,119.2,167.8,117.3,169.1z"/>
				...
				<g>
					<g>
						<g>
							<path className={st4Class} d="M155.6,174.4v-8.9h1.3l3.8,6.5H160l3.8-6.5h1.3l0,8.9h-1.6V168h0.3l-3.2,5.4H160l-3.2-5.4h0.4v6.4H155.6z"
							/>
							<path className={st4Class} d="M171.2,174.6c-1.2,0-2.1-0.3-2.8-1c-0.7-0.7-1-1.7-1-3v-5h1.6v5c0,0.9,0.2,1.6,0.6,2
					...
					C173.3,174.2,172.4,174.6,171.2,174.6z"/>
							<path className={st4Class} d="M177.3,174.4v-8.9h1.6v7.5h4.6v1.4H177.3z" />
							<path className={st4Class} d="M186.5,174.4v-7.5h-2.9v-1.4h7.4v1.4h-2.9v7.5H186.5z" />
							<path className={st4Class} d="M192.3,174.4v-8.9h1.6v8.9H192.3z" />
							<path className={st4Class} d="M195.9,170.6v-1.3h3.4v1.3H195.9z" />
							<path className={st4Class} d="M201.3,174.4v-8.9h1.3l3.8,6.5h-0.7l3.8-6.5h1.3l0,8.9h-1.6V168h0.3l-3.2,5.4h-0.7l-3.2-5.4h0.4v6.4H201.3z
					"/>
							<path className={st4Class} d="M217.3,174.6c-0.7,0-1.3-0.1-1.9-0.3s-1.1-0.6-1.5-1c-0.4-0.4-0.8-0.9-1-1.5c-0.2-0.6-0.3-1.2-0.3-1.8
					...
					c0.3,0.3,0.6,0.5,1,0.7C216.4,173,216.8,173.1,217.3,173.1z"/>
							<path className={st4Class} d="M223.7,174.4v-8.9h3.8c0.9,0,1.8,0.2,2.5,0.6c0.7,0.4,1.3,0.9,1.7,1.6c0.4,0.7,0.6,1.4,0.6,2.3
					...
					V173z"/>
							<path className={st4Class} d="M232.7,174.4l3.9-8.9h1.6l3.9,8.9h-1.7l-3.4-8h0.6l-3.4,8H232.7z M234.5,172.4l0.4-1.3h4.7l0.4,1.3H234.5z"
							/>
							<path className={st4Class} d="M243.3,174.4v-8.9h1.6v7.5h4.6v1.4H243.3z" />
							<path className={st4Class} d="M256.8,174.4l-3.8-8.9h1.8l3.4,8h-1l3.5-8h1.6l-3.8,8.9H256.8z" />
							<path className={st4Class} d="M263.3,174.4v-8.9h1.6v8.9H263.3z" />
							<path className={st4Class} d="M267.2,174.4v-8.9h3.8c0.9,0,1.8,0.2,2.5,0.6c0.7,0.4,1.3,0.9,1.7,1.6c0.4,0.7,0.6,1.4,0.6,2.3
					c0,0.9-0.2,1.7-0.6,2.3c-0.4,0.7-1,1.2-1.7,1.6s-1.5,0.6-2.5,0.6H267.2z M268.9,173h2.1c0.7,0,1.2-0.1,1.7-0.4
					c0.5-0.3,0.9-0.6,1.1-1.1c0.3-0.5,0.4-1,0.4-1.6c0-0.6-0.1-1.2-0.4-1.6c-0.3-0.4-0.6-0.8-1.1-1.1c-0.5-0.3-1-0.4-1.7-0.4h-2.1
					V173z"/>
							<path className={st4Class} d="M279.1,173h4.9v1.4h-6.5v-8.9h6.4v1.4h-4.7V173z M279,169.2h4.3v1.4H279V169.2z" />
							<path className={st4Class} d="M290,174.6c-0.7,0-1.3-0.1-1.9-0.3s-1.1-0.6-1.5-1c-0.4-0.4-0.8-0.9-1-1.5s-0.3-1.2-0.3-1.8
					c0-0.7,0.1-1.3,0.3-1.8c0.2-0.6,0.6-1,1-1.4c0.4-0.4,0.9-0.7,1.5-1s1.2-0.3,1.9-0.3c0.7,0,1.3,0.1,1.9,0.3
					...
					c0.3,0.3,0.6,0.5,1,0.7C289.1,173,289.5,173.1,290,173.1z"/>
							<path className={st4Class} d="M302.5,174.6c-0.7,0-1.3-0.1-2-0.3c-0.6-0.2-1.1-0.5-1.5-0.8l0.6-1.3c0.3,0.3,0.8,0.5,1.3,0.7
					...
					c-0.3,0.4-0.6,0.7-1.2,1C304,174.4,303.3,174.6,302.5,174.6z"/>
							<path className={st4Class} d="M309.3,173h4.9v1.4h-6.5v-8.9h6.4v1.4h-4.7V173z M309.1,169.2h4.3v1.4h-4.3V169.2z" />
							<path className={st4Class} d="M314.8,174.4l3.9-8.9h1.6l3.9,8.9h-1.7l-3.4-8h0.6l-3.4,8H314.8z M316.6,172.4l0.4-1.3h4.7l0.4,1.3H316.6z"
							/>
							<path className={st4Class} d="M325.3,174.4v-8.9h3.6c0.8,0,1.4,0.1,2,0.4c0.6,0.2,1,0.6,1.3,1.1c0.3,0.5,0.4,1,0.4,1.7
					...
					l-2.2-3.2h1.7l2.2,3.2H331z"/>
							<path className={st4Class} d="M338.5,174.6c-0.7,0-1.3-0.1-1.9-0.3c-0.6-0.2-1.1-0.5-1.5-1c-0.4-0.4-0.7-0.9-1-1.4
					...
					c0.4,0.2,0.8,0.2,1.3,0.2c0.4,0,0.9-0.1,1.3-0.3s0.7-0.4,1.1-0.8l1,1c-0.4,0.5-0.9,0.9-1.5,1.1S339.2,174.6,338.5,174.6z"/>
							<path className={st4Class} d="M345.1,174.4h-1.6v-8.9h1.6V174.4z M349.8,170.6H345v-1.4h4.8V170.6z M349.6,165.6h1.6v8.9h-1.6V165.6z" />
							<path className={st4Class} d="M358.6,173h4.9v1.4H357v-8.9h6.4v1.4h-4.7V173z M358.5,169.2h4.3v1.4h-4.3V169.2z" />
							<path className={st4Class} d="M365.4,174.4v-8.9h1.3l5.5,6.9h-0.7v-6.9h1.6v8.9h-1.3l-5.5-6.9h0.7v6.9H365.4z" />
							<path className={st4Class} d="M379.6,174.6c-0.7,0-1.3-0.1-1.9-0.3c-0.6-0.2-1.1-0.5-1.5-1c-0.4-0.4-0.8-0.9-1-1.4
					c-0.2-0.5-0.3-1.2-0.3-1.8c0-0.7,0.1-1.3,0.3-1.8c0.2-0.6,0.6-1,1-1.4c0.4-0.4,0.9-0.7,1.5-1c0.6-0.2,1.2-0.3,1.9-0.3
					...
					C380.8,174.5,380.2,174.6,379.6,174.6z M381.4,173.2v-3.3h1.5v3.5L381.4,173.2z"/>
							<path className={st4Class} d="M385.1,174.4v-8.9h1.6v8.9H385.1z" />
							<path className={st4Class} d="M389.1,174.4v-8.9h1.3l5.5,6.9h-0.7v-6.9h1.6v8.9h-1.3l-5.5-6.9h0.7v6.9H389.1z" />
							<path className={st4Class} d="M400.8,173h4.9v1.4h-6.5v-8.9h6.4v1.4h-4.7V173z M400.7,169.2h4.3v1.4h-4.3V169.2z" />
						</g>
					</g>
				</g>
			</g>

...
export const TBTPdesc = "TwinBlades Template 是一个基于 Next.js 和 Tailwind CSS 的前端模板项目，集成了日常开发中最常用的基础功能组件和工具。内置国际化（i18n）配置支持多语言切换，封装常用的数据请求 Hook 简化API调用，集成键盘事件监听支持快捷键操作，并包含可复用的弹窗提示组件和全局状态管理的 Provider 模板，帮助开发者快速搭建交互友好的用户界面。"
